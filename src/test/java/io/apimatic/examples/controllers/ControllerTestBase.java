...
import io.apimatic.examples.CalculatorAPIClient;
...
public class ControllerTestBase {
    ...
    private static CalculatorAPIClient client;
     ...
     * @return
     */
    protected static CalculatorAPIClient getClient() {
        if (client == null) {
            synchronized (clientSync) {
                if (client == null) {
                    client = new CalculatorAPIClient();
                }
            }
        }
        return client;
